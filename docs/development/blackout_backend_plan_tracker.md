...
- [ ] [deferred-with-signoff] Define canonical policy doc for what *is* persisted: (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] User accounts (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] Device keys / cross-signing state (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] Room membership and auth-critical state (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] Signaling events (ephemeral retention window) (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Define what is *not* persisted: (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] `m.room.message` bodies (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] `m.room.encrypted` payloads (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] Media binaries (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] Search indexes (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 1.2 Homeserver behavior changes
- [ ] [deferred-with-signoff] Add event-persistence gate in write path to reject/discard non-allowed content types. (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Ensure auth/state resolution remains intact when payload events are not persisted. (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Add config toggle for migration period: (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] `blackout_signaling_only_mode: true|false` (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 1.3 Feature disablement
- [ ] [deferred-with-signoff] Disable media repository endpoints and background jobs. (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Disable event indexing/search paths. (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Remove/disable message history retrieval surfaces for blocked event classes. (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 1.4 Validation
- [ ] [deferred-with-signoff] Integration test: account + membership flows still pass. (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Integration test: message events are rejected or dropped per policy. (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Migration test: existing deployments can enable mode without DB corruption. (owner: Backend Lead; due: 2026-03-22; exit criteria: write-path/storage policy behavior implemented and validated in staging; evidence: docs/signaling_only_persistence_policy.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
...
### 2.1 Spec and schema
- [ ] [deferred-with-signoff] Define event schema/versioning for `m.blackout.signal`. (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Allowed content classes: (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] ICE candidates (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] SDP offers/answers (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] Message metadata descriptors (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] Chunk announcements (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Define max payload size and validation rules. (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 2.2 Enforcement
- [ ] [deferred-with-signoff] Add server-side validator for `m.blackout.signal` content. (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Hard-block storage of: (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] `m.room.message` (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] `m.room.encrypted` (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Emit explicit error codes for blocked event types. (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 2.3 Interop
- [ ] [deferred-with-signoff] Document expected client behavior/fallback. (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Add conformance tests for accepted and rejected payloads. (owner: Protocol Engineer; due: 2026-03-24; exit criteria: signaling schema/validator and blocked-event behavior are test-backed; evidence: docs/policy_schemas/blackout_dead_drop_room.schema.json, blackout_runtime_tests/test_server_semantics.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
...
- [ ] [deferred-with-signoff] Decide primary model: (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] Embedded phone-host STUN/TURN (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] External `coturn` sidecar/recommended default (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Publish minimal secure `coturn` baseline config. (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 3.2 Server responsibility boundaries
- [ ] [deferred-with-signoff] Server assists NAT traversal coordination only. (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Server does not relay payload by default. (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Add rate limits/abuse controls for signaling storms. (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 3.3 Ops and observability
- [ ] [deferred-with-signoff] Add health checks for TURN/STUN dependency. (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Add metrics: setup success, candidate failure rates, relay fallback ratio. (owner: Infra Lead; due: 2026-03-25; exit criteria: TURN/STUN baseline, health, and metrics contract documented and staged; evidence: docs/blackout-ops-runbook.md, docs/reliability_slo_instrumentation.md; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
...
- [ ] [deferred-with-signoff] Add config: (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] `blackout_signal_ttl_hours` (24–72) (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
  - [ ] [deferred-with-signoff] `blackout_purge_interval_minutes` (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Define TTL semantics (based on event creation vs. receipt time). (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 4.2 Purge implementation
- [ ] [deferred-with-signoff] Background purge job for expired signaling events. (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Ensure purge is incremental and bounded. (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Ensure purged content is irretrievable via APIs. (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)

### 4.3 Safety
- [ ] [deferred-with-signoff] Retention tests (unit + integration). (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
- [ ] [deferred-with-signoff] Verify purge does not remove auth-critical room state. (owner: Data Lifecycle Engineer; due: 2026-03-26; exit criteria: TTL + purge workflow verified with retention tests; evidence: docs/development/blackout_retention_compliance_note.md, blackout_runtime_tests/test_policy_engine.py; approval: Architecture Council 2026-03-15; trigger: Wave-1 execution kickoff with implementation PR links)
...
| deferred-with-signoff | Tracker-tagged backlog items deferred pending Wave-1 execution kickoff | Section 13.5 deferred register |
