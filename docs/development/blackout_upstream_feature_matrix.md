...
| U5 | Stego plugin surface | required-later | partial | Extension Platform Lead | 2026-05-15 | Plugin metadata/signature policy contract is kickoff-defined with security controls and conformance test plan. | `docs/upstream_blackout_feature_build_plan.md`; `docs/development/wave3_u5_u12_kickoff_plan.md`; contract + tests (to be added) |
...
| U12 | Module/runtime extensibility | required-later | partial | Runtime Extensibility Lead | 2026-05-15 | Runtime extension contract and capability negotiation model are kickoff-defined with compatibility gates and test plan. | `docs/upstream_blackout_feature_build_plan.md`; `docs/development/wave3_u5_u12_kickoff_plan.md`; extensibility contract/tests (to be added) |
